...
@Component({
  ...
  standalone: true,
  imports: [InputSearchComponent, MatIcon, MatTableModule, MatSidenavModule, MatPaginatorModule, CategoriaDetailPopupComponent],
...
export class CategoriaComponent implements OnInit {
  ...
  dataSource = new MatTableDataSource<Categoria>(); // Cambiar a MatTableDataSource
